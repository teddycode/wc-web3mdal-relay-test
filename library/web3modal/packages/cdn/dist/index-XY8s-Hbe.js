import { n as fe, s as Ke, T as k, o as Y, R as jo, a as g, t as P, p as H, y as ae } from "./index-AZs2r2yB.js";
import { t as Ho, bo as Bo } from "./client-CWmvRiz4.js";
/**
 * @license
...
const Zo = (t) => new xo(typeof t == "string" ? t : t + "", void 0, Bt), C = (t, ...e) => {
 ...
 */
var ot;
const Ye = window, Kt = Ye.trustedTypes, Vo = Kt ? Kt.emptyScript : "", Qt = Ye.reactiveElementPolyfillSupport, Lt = { toAttribute(t, e) {
  switch (e) {
    case Boolean:
      t = t ? Vo : null;
      break;
 ...
 */
var it;
const Ge = window, be = Ge.trustedTypes, Yt = be ? be.createPolicy("lit-html", { createHTML: (t) => t }) : void 0, Wt = "$lit$", Q = `lit$${(Math.random() + "").slice(9)}$`, Co = "?" + Q, Fo = `<${Co}>`, le = document, Se = () => le.createComment(""), Le = (t) => t === null || typeof t != "object" && typeof t != "function", Ao = Array.isArray, qo = (t) => Ao(t) || typeof (t == null ? void 0 : t[Symbol.iterator]) == "function", nt = `[ 	
...
const Ko = (t, e) => {
  ...
  for (let l = 0; l < o; l++) {
    ...
    n += a === Ce ? c + Fo : $ >= 0 ? (i.push(d), c.slice(0, $) + Wt + c.slice($) + Q + _) : c + Q + ($ === -2 ? (i.push(void 0), l) : _);
  }
...
class Pe {
  constructor({ strings: e, _$litType$: o }, i) {
    ...
    this.parts = [];
    let n = 0, a = 0;
    const l = e.length - 1, c = this.parts, [d, x] = Ko(e, o);
          ...
          for (const m of r.getAttributeNames())
            if (m.endsWith(Wt) || m.startsWith(Q)) {
              ...
              if ($.push(m), _ !== void 0) {
                ...
                c.push({ type: 1, index: n, name: u[2], strings: f, ctor: u[1] === "." ? Yo : u[1] === "?" ? Xo : u[1] === "@" ? Jo : tt });
              } else
...
class Qo {
  ...
  u(e) {
    ...
    for (; d !== void 0; ) {
      if (l === d.index) {
        let x;
        d.type === 2 ? x = new Ne(a, a.nextSibling, this, e) : d.type === 1 ? x = new d.ctor(a, d.name, d.strings, this, e) : d.type === 6 && (x = new er(a, this, e)), this._$AV.push(x), d = r[++c];
      }
...
class Ne {
  ...
  _$AI(e, o = this) {
    e = ye(this, e, o), Le(e) ? e === M || e == null || e === "" ? (this._$AH !== M && this._$AR(), this._$AH = M) : e !== this._$AH && e !== se && this._(e) : e._$litType$ !== void 0 ? this.g(e) : e.nodeType !== void 0 ? this.$(e) : qo(e) ? this.T(e) : this._(e);
  }
  k(e) {
  ...
  g(e) {
    ...
    if (((o = this._$AH) === null || o === void 0 ? void 0 : o._$AD) === n)
      ...
      const a = new Qo(n, this), l = a.u(this.options);
...
const Go = be ? be.emptyScript : "";
let Xo = class extends tt {
  constructor() {
    super(...arguments), this.type = 4;
  }
  j(e) {
    e && e !== M ? this.element.setAttribute(this.name, Go) : this.element.removeAttribute(this.name);
  }
};
class Jo extends tt {
  constructor(e, o, i, r, n) {
...
class w extends ue {
  ...
  update(e) {
    const o = this.render();
    this.hasUpdated || (this.renderOptions.isConnected = this.isConnected), super.update(e), this._$Do = tr(o, this.renderRoot, this.renderOptions);
  }
  connectedCallback() {
    var e;
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const or = (t, e) => e.kind === "method" && e.descriptor && !("value" in e.descriptor) ? { ...e, finisher(o) {
...
function p(t) {
  return (e, o) => o !== void 0 ? rr(t, e, o) : or(t, e);
}
/**
 * @license
 * Copyright 2017 Google LLC
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const ir = { ATTRIBUTE: 1, CHILD: 2, PROPERTY: 3, BOOLEAN_ATTRIBUTE: 4, EVENT: 5, ELEMENT: 6 }, nr = (t) => (...e) => ({ _$litDirective$: t, values: e });
class ar {
  constructor(e) {
  }
  get _$AU() {
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const Z = nr(class extends ar {
  constructor(t) {
    var e;
    if (super(t), t.type !== ir.ATTRIBUTE || t.name !== "class" || ((e = t.strings) === null || e === void 0 ? void 0 : e.length) > 2)
...
const Oo = (t, e, o) => Math.min(Math.max(o, t), e), D = {
  ...
  repeat: 0,
  easing: "ease"
}, Xe = (t) => typeof t == "number", we = (t) => Array.isArray(t) && !Xe(t[0]), sr = (t, e, o) => {
  const i = e - t;
  return ((o - t) % i + i) % i + t;
};
function cr(t, e) {
  return we(t) ? t[sr(0, t.length, e)] : t;
}
...
function hr(t, e = dr(t.length), o = G) {
  ...
  return r > 0 && Mo(e, r), (n) => {
    ...
    return l = cr(o, a)(l), Io(t[a], t[a + 1], l);
  };
}
const Ro = (t) => Array.isArray(t) && Xe(t[0]), Nt = (t) => typeof t == "object" && !!t.createAnimation, xe = (t) => typeof t == "function", mr = (t) => typeof t == "string", Re = {
  ms: (t) => t * 1e3,
  s: (t) => t / 1e3
}, So = (t, e, o) => (((1 - 3 * o + 3 * e) * t + (3 * o - 6 * e)) * t + 3 * e) * t, pr = 1e-7, ur = 12;
function gr(t, e, o, i, r) {
  let n, a, l = 0;
  do
    a = e + (o - e) / 2, n = So(a, i, r) - t, n > 0 ? o = a : e = a;
  while (Math.abs(n) > pr && ++l < ur);
  return a;
}
function Me(t, e, o, i) {
  if (t === e && o === i)
    return G;
  const r = (n) => gr(n, 0, 1, t, o);
...
function io(t) {
  ...
  if (t.startsWith("steps")) {
    ...
    if (o) {
      const i = o[1].split(",");
      return wr(parseFloat(i[0]), i[1].trim());
    }
  }
  return G;
}
...
Ho.env.NODE_ENV !== "production" && (Dt = function(t, e) {
  if (!t)
    throw new Error(e);
});
class br {
...
function yr(t, e) {
  return t.has(e) || t.set(e, new br()), t.get(e);
}
const xr = ["", "X", "Y", "Z"], $r = ["translate", "scale", "rotate", "skew"], Je = {
  x: "translateX",
  y: "translateY",
  z: "translateZ"
}, no = {
...
$r.forEach((t) => {
  xr.forEach((e) => {
    et.push(t + e), We.set(zt(t + e), Cr[t]);
  });
});
const Ar = (t, e) => et.indexOf(t) - et.indexOf(e), _r = new Set(et), Wo = (t) => _r.has(t), Er = (t, e) => {
  Je[e] && (e = Je[e]);
  const { transforms: o } = Po(t);
  lr(o, e), t.style.transform = kr(o);
}, kr = (t) => t.sort(Ar).reduce(Or, "").trim(), Or = (t, e) => `${t} ${e}(var(${zt(e)}))`, Ut = (t) => t.startsWith("--"), ao = /* @__PURE__ */ new Set();
function Ir(t) {
  if (!ao.has(t)) {
    ao.add(t);
    try {
...
const Tr = 0.015, Mr = (t, e) => {
  let o = "";
  const i = Math.round(e / Tr);
  for (let r = 0; r < i; r++)
    o += t(Zt(0, i - 1, r)) + ", ";
  return o.substring(0, o.length - 2);
}, so = (t, e) => xe(t) ? ge.linearEasing() ? `linear(${Mr(t, e)})` : D.easing : Ro(t) ? Rr(t) : t, Rr = ([t, e, o, i]) => `cubic-bezier(${t}, ${e}, ${o}, ${i})`;
function Sr(t, e) {
  for (let o = 0; o < t.length; o++)
    t[o] === null && (t[o] = o ? t[o - 1] : e());
  return t;
}
const Lr = (t) => Array.isArray(t) ? t : [t];
function jt(t) {
...
function Nr(t, e, o, i = {}, r) {
  const n = Wr(), a = i.record !== !1 && n;
  ...
  let N = ge.waapi();
  S && Er(t, e);
  const U = jt(e), De = yr(R.values, U), z = We.get(U);
  return No(De.animation, !(Nt(m) && De.generator) && i.record !== !1), () => {
    ...
    if (Ut(U) && (ge.cssRegisterProperty() ? Ir(U) : N = !1), S && !ge.linearEasing() && (xe(m) || we(m) && m.some(xe)) && (N = !1), N) {
...
const jr = (t) => t(), Do = (t, e, o = D.duration) => new Proxy({
  animations: t.map(jr).filter(Boolean),
  duration: o,
  options: e
}, Br), Hr = (t) => t.animations[0], Br = {
  get: (t, e) => {
    const o = Hr(t);
    switch (e) {
      case "duration":
      ...
      case "finished":
        return t.finished || (t.finished = Promise.all(t.animations.map(Zr)).catch(To)), t.finished;
      case "stop":
        return () => {
 ...
 */
const L = (t) => t ?? M;
var Kr = Object.defineProperty, co = Object.getOwnPropertySymbols, Qr = Object.prototype.hasOwnProperty, Yr = Object.prototype.propertyIsEnumerable, ho = (t, e, o) => e in t ? Kr(t, e, { enumerable: !0, configurable: !0, writable: !0, value: o }) : t[e] = o, mt = (t, e) => {
  for (var o in e || (e = {}))
    Qr.call(e, o) && ho(t, o, e[o]);
  if (co)
    for (var o of co(e))
      Yr.call(e, o) && ho(t, o, e[o]);
  return t;
};
function Gr() {
  var t;
...
var Jr = Object.defineProperty, ei = Object.getOwnPropertyDescriptor, ce = (t, e, o, i) => {
  for (var r = i > 1 ? void 0 : i ? ei(e, o) : e, n = t.length - 1, a; n >= 0; n--)
    (a = t[n]) && (r = (i ? a(e, o, r) : a(r)) || r);
  return i && r && Jr(e, o, r), r;
};
...
V.styles = [v.globalCss, Xr], ce([p({ type: Boolean })], V.prototype, "disabled", 2), ce([p()], V.prototype, "iconLeft", 2), ce([p()], V.prototype, "iconRight", 2), ce([p()], V.prototype, "onClick", 2), ce([p()], V.prototype, "variant", 2), V = ce([y("wcm-button")], V);
...
var oi = Object.defineProperty, ri = Object.getOwnPropertyDescriptor, pt = (t, e, o, i) => {
  for (var r = i > 1 ? void 0 : i ? ri(e, o) : e, n = t.length - 1, a; n >= 0; n--)
    (a = t[n]) && (r = (i ? a(e, o, r) : a(r)) || r);
...
Ae.styles = [v.globalCss, ti], pt([p({ type: Boolean })], Ae.prototype, "disabled", 2), pt([p()], Ae.prototype, "variant", 2), Ae = pt([y("wcm-button-big")], Ae);
...
ut.styles = [v.globalCss, ii], ut = ni([y("wcm-info-footer")], ut);
...
gt.styles = [v.globalCss, ai], gt = li([y("wcm-modal-backcard")], gt);
const si = C`main{padding:20px;padding-top:0;width:100%}`;
var ci = (t, e, o, i) => {
  for (var r = e, n = t.length - 1, a; n >= 0; n--)
    (a = t[n]) && (r = a(r) || r);
  return r;
...
wt.styles = [v.globalCss, si], wt = ci([y("wcm-modal-content")], wt);
const di = C`footer{padding:10px;display:flex;flex-direction:column;align-items:inherit;justify-content:inherit;border-top:1px solid var(--wcm-color-bg-2)}`;
var hi = (t, e, o, i) => {
  for (var r = e, n = t.length - 1, a; n >= 0; n--)
    (a = t[n]) && (r = a(r) || r);
  return r;
...
vt.styles = [v.globalCss, di], vt = hi([y("wcm-modal-footer")], vt);
const mi = C`header{display:flex;justify-content:center;align-items:center;padding:20px;position:relative}.wcm-border{border-bottom:1px solid var(--wcm-color-bg-2);margin-bottom:20px}header button{padding:15px 20px}header button:active{opacity:.5}@media(hover:hover){header button:hover{opacity:.5}}.wcm-back-btn{position:absolute;left:0}.wcm-action-btn{position:absolute;right:0}path{fill:var(--wcm-accent-color)}`;
var pi = Object.defineProperty, ui = Object.getOwnPropertyDescriptor, _e = (t, e, o, i) => {
...
te.styles = [v.globalCss, mi], _e([p()], te.prototype, "title", 2), _e([p()], te.prototype, "onAction", 2), _e([p()], te.prototype, "actionIcon", 2), _e([p({ type: Boolean })], te.prototype, "border", 2), te = _e([y("wcm-modal-header")], te);
...
} }, gi = C`.wcm-router{overflow:hidden;will-change:transform}.wcm-content{display:flex;flex-direction:column}`;
var wi = Object.defineProperty, vi = Object.getOwnPropertyDescriptor, ft = (t, e, o, i) => {
  for (var r = i > 1 ? void 0 : i ? vi(e, o) : e, n = t.length - 1, a; n >= 0; n--)
    (a = t[n]) && (r = (i ? a(e, o, r) : a(r)) || r);
  return i && r && wi(e, o, r), r;
};
...
Ee.styles = [v.globalCss, gi], ft([W()], Ee.prototype, "view", 2), ft([W()], Ee.prototype, "prevView", 2), Ee = ft([y("wcm-modal-router")], Ee);
const fi = C`div{height:36px;width:max-content;display:flex;justify-content:center;align-items:center;padding:9px 15px 11px;position:absolute;top:12px;box-shadow:0 6px 14px -6px rgba(10,16,31,.3),0 10px 32px -4px rgba(10,16,31,.15);z-index:2;left:50%;transform:translateX(-50%);pointer-events:none;backdrop-filter:blur(20px) saturate(1.8);-webkit-backdrop-filter:blur(20px) saturate(1.8);border-radius:var(--wcm-notification-border-radius);border:1px solid var(--wcm-color-overlay);background-color:var(--wcm-color-overlay)}svg{margin-right:5px}@-moz-document url-prefix(){div{background-color:var(--wcm-color-bg-3)}}.wcm-success path{fill:var(--wcm-accent-color)}.wcm-error path{fill:var(--wcm-error-color)}`;
var bi = Object.defineProperty, yi = Object.getOwnPropertyDescriptor, po = (t, e, o, i) => {
...
He.styles = [v.globalCss, fi], po([W()], He.prototype, "open", 2), He = po([y("wcm-modal-toast")], He);
const xi = 0.1, uo = 2.5, B = 7;
function bt(t, e, o) {
  return t === e ? !1 : (t - e < 0 ? e - t : t - e) <= o + xi;
}
function $i(t, e) {
  const o = Array.prototype.slice.call(Bo.create(t, { errorCorrectionLevel: e }).modules.data, 0), i = Math.sqrt(o.length);
  return o.reduce((r, n, a) => (a % i === 0 ? r.push([n]) : r[r.length - 1].push(n)) && r, []);
}
const Ci = { generate(t, e, o) {
  const i = "#141414", r = "#ffffff", n = [], a = $i(t, "Q"), l = e / a.length, c = [{ x: 0, y: 0 }, { x: 1, y: 0 }, { x: 0, y: 1 }];
  c.forEach(({ x: f, y: u }) => {
...
} }, Ai = C`@keyframes fadeIn{0%{opacity:0}100%{opacity:1}}div{position:relative;user-select:none;display:block;overflow:hidden;aspect-ratio:1/1;animation:fadeIn ease .2s}.wcm-dark{background-color:#fff;border-radius:var(--wcm-container-border-radius);padding:18px;box-shadow:0 2px 5px #000}svg:first-child,wcm-wallet-image{position:absolute;top:50%;left:50%;transform:translateY(-50%) translateX(-50%)}wcm-wallet-image{transform:translateY(-50%) translateX(-50%)}wcm-wallet-image{width:25%;height:25%;border-radius:var(--wcm-wallet-icon-border-radius)}svg:first-child{transform:translateY(-50%) translateX(-50%) scale(.9)}svg:first-child path:first-child{fill:var(--wcm-accent-color)}svg:first-child path:last-child{stroke:var(--wcm-color-overlay)}`;
var _i = Object.defineProperty, Ei = Object.getOwnPropertyDescriptor, de = (t, e, o, i) => {
  for (var r = i > 1 ? void 0 : i ? Ei(e, o) : e, n = t.length - 1, a; n >= 0; n--)
    (a = t[n]) && (r = (i ? a(e, o, r) : a(r)) || r);
  return i && r && _i(e, o, r), r;
};
let F = class extends w {
  ...
  svgTemplate() {
    ...
    return E`<svg height="${t}" width="${t}">${Ci.generate(this.uri, t, t / 4)}</svg>`;
  }
  render() {
...
F.styles = [v.globalCss, Ai], de([p()], F.prototype, "uri", 2), de([p({ type: Number })], F.prototype, "size", 2), de([p()], F.prototype, "imageId", 2), de([p()], F.prototype, "walletId", 2), de([p()], F.prototype, "imageUrl", 2), F = de([y("wcm-qrcode")], F);
const ki = C`:host{position:relative;height:28px;width:80%}input{width:100%;height:100%;line-height:28px!important;border-radius:var(--wcm-input-border-radius);font-style:normal;font-family:-apple-system,system-ui,BlinkMacSystemFont,'Segoe UI',Roboto,Ubuntu,'Helvetica Neue',sans-serif;font-feature-settings:'case' on;font-weight:500;font-size:16px;letter-spacing:-.03em;padding:0 10px 0 34px;transition:.2s all ease;color:var(--wcm-color-fg-1);background-color:var(--wcm-color-bg-3);box-shadow:inset 0 0 0 1px var(--wcm-color-overlay);caret-color:var(--wcm-accent-color)}input::placeholder{color:var(--wcm-color-fg-2)}svg{left:10px;top:4px;pointer-events:none;position:absolute;width:20px;height:20px}input:focus-within{box-shadow:inset 0 0 0 1px var(--wcm-accent-color)}path{fill:var(--wcm-color-fg-2)}`;
var Oi = Object.defineProperty, Ii = Object.getOwnPropertyDescriptor, go = (t, e, o, i) => {
...
Be.styles = [v.globalCss, ki], go([p()], Be.prototype, "onChange", 2), Be = go([y("wcm-search-input")], Be);
const Ti = C`@keyframes rotate{100%{transform:rotate(360deg)}}@keyframes dash{0%{stroke-dasharray:1,150;stroke-dashoffset:0}50%{stroke-dasharray:90,150;stroke-dashoffset:-35}100%{stroke-dasharray:90,150;stroke-dashoffset:-124}}svg{animation:rotate 2s linear infinite;display:flex;justify-content:center;align-items:center}svg circle{stroke-linecap:round;animation:dash 1.5s ease infinite;stroke:var(--wcm-accent-color)}`;
var Mi = (t, e, o, i) => {
  for (var r = e, n = t.length - 1, a; n >= 0; n--)
    (a = t[n]) && (r = a(r) || r);
  return r;
...
ke.styles = [v.globalCss, Ri], xt([p()], ke.prototype, "variant", 2), xt([p()], ke.prototype, "color", 2), ke = xt([y("wcm-text")], ke);
const Pi = C`button{width:100%;height:100%;border-radius:var(--wcm-button-hover-highlight-border-radius);display:flex;align-items:flex-start}button:active{background-color:var(--wcm-color-overlay)}@media(hover:hover){button:hover{background-color:var(--wcm-color-overlay)}}button>div{width:80px;padding:5px 0;display:flex;flex-direction:column;align-items:center}wcm-text{width:100%;white-space:nowrap;overflow:hidden;text-overflow:ellipsis;text-align:center}wcm-wallet-image{height:60px;width:60px;transition:all .2s ease;border-radius:var(--wcm-wallet-icon-border-radius);margin-bottom:5px}.wcm-sublabel{margin-top:2px}`;
var Wi = Object.defineProperty, Ni = Object.getOwnPropertyDescriptor, q = (t, e, o, i) => {
  for (var r = i > 1 ? void 0 : i ? Ni(e, o) : e, n = t.length - 1, a; n >= 0; n--)
    (a = t[n]) && (r = (i ? a(e, o, r) : a(r)) || r);
  return i && r && Wi(e, o, r), r;
};
...
j.styles = [v.globalCss, Pi], q([p()], j.prototype, "onClick", 2), q([p()], j.prototype, "name", 2), q([p()], j.prototype, "walletId", 2), q([p()], j.prototype, "label", 2), q([p()], j.prototype, "imageId", 2), q([p({ type: Boolean })], j.prototype, "installed", 2), q([p({ type: Boolean })], j.prototype, "recent", 2), j = q([y("wcm-wallet-button")], j);
const Di = C`:host{display:block}div{overflow:hidden;position:relative;border-radius:inherit;width:100%;height:100%;background-color:var(--wcm-color-overlay)}svg{position:relative;width:100%;height:100%}div::after{content:'';position:absolute;top:0;bottom:0;left:0;right:0;border-radius:inherit;border:1px solid var(--wcm-color-overlay)}div img{width:100%;height:100%;object-fit:cover;object-position:center}#wallet-placeholder-fill{fill:var(--wcm-color-bg-3)}#wallet-placeholder-dash{stroke:var(--wcm-color-overlay)}`;
var Ui = Object.defineProperty, ji = Object.getOwnPropertyDescriptor, Ze = (t, e, o, i) => {
  for (var r = i > 1 ? void 0 : i ? ji(e, o) : e, n = t.length - 1, a; n >= 0; n--)
    (a = t[n]) && (r = (i ? a(e, o, r) : a(r)) || r);
...
he.styles = [v.globalCss, Di], Ze([p()], he.prototype, "walletId", 2), Ze([p()], he.prototype, "imageId", 2), Ze([p()], he.prototype, "imageUrl", 2), he = Ze([y("wcm-wallet-image")], he);
var Hi = Object.defineProperty, Bi = Object.getOwnPropertyDescriptor, wo = (t, e, o, i) => {
...
Ct.styles = [v.globalCss, zi], Ct = Vi([y("wcm-android-wallet-selection")], Ct);
const Fi = C`@keyframes loading{to{stroke-dashoffset:0}}@keyframes shake{10%,90%{transform:translate3d(-1px,0,0)}20%,80%{transform:translate3d(1px,0,0)}30%,50%,70%{transform:translate3d(-2px,0,0)}40%,60%{transform:translate3d(2px,0,0)}}:host{display:flex;flex-direction:column;align-items:center}div{position:relative;width:110px;height:110px;display:flex;justify-content:center;align-items:center;margin:40px 0 20px 0;transform:translate3d(0,0,0)}svg{position:absolute;width:110px;height:110px;fill:none;stroke:transparent;stroke-linecap:round;stroke-width:2px;top:0;left:0}use{stroke:var(--wcm-accent-color);animation:loading 1s linear infinite}wcm-wallet-image{border-radius:var(--wcm-wallet-icon-large-border-radius);width:90px;height:90px}wcm-text{margin-bottom:40px}.wcm-error svg{stroke:var(--wcm-error-color)}.wcm-error use{display:none}.wcm-error{animation:shake .4s cubic-bezier(.36,.07,.19,.97) both}.wcm-stale svg,.wcm-stale use{display:none}`;
var qi = Object.defineProperty, Ki = Object.getOwnPropertyDescriptor, me = (t, e, o, i) => {
...
K.styles = [v.globalCss, Fi], me([p()], K.prototype, "walletId", 2), me([p()], K.prototype, "imageId", 2), me([p({ type: Boolean })], K.prototype, "isError", 2), me([p({ type: Boolean })], K.prototype, "isStale", 2), me([p()], K.prototype, "label", 2), K = me([y("wcm-connector-waiting")], K);
...
At.styles = [v.globalCss, Qi], At = Yi([y("wcm-desktop-wallet-selection")], At);
const Gi = C`div{background-color:var(--wcm-color-bg-2);padding:10px 20px 15px 20px;border-top:1px solid var(--wcm-color-bg-3);text-align:center}a{color:var(--wcm-accent-color);text-decoration:none;transition:opacity .2s ease-in-out;display:inline}a:active{opacity:.8}@media(hover:hover){a:hover{opacity:.8}}`;
var Xi = (t, e, o, i) => {
  for (var r = e, n = t.length - 1, a; n >= 0; n--)
    (a = t[n]) && (r = a(r) || r);
  return r;
...
_t.styles = [v.globalCss, Gi], _t = Xi([y("wcm-legal-notice")], _t);
const Ji = C`div{display:grid;grid-template-columns:repeat(4,80px);margin:0 -10px;justify-content:space-between;row-gap:10px}`;
var en = (t, e, o, i) => {
  for (var r = e, n = t.length - 1, a; n >= 0; n--)
    (a = t[n]) && (r = a(r) || r);
  return r;
...
Et.styles = [v.globalCss, Ji], Et = en([y("wcm-mobile-wallet-selection")], Et);
const tn = C`:host{all:initial}.wcm-overlay{top:0;bottom:0;left:0;right:0;position:fixed;z-index:var(--wcm-z-index);overflow:hidden;display:flex;justify-content:center;align-items:center;opacity:0;pointer-events:none;background-color:var(--wcm-overlay-background-color);backdrop-filter:var(--wcm-overlay-backdrop-filter)}@media(max-height:720px) and (orientation:landscape){.wcm-overlay{overflow:scroll;align-items:flex-start;padding:20px 0}}.wcm-active{pointer-events:auto}.wcm-container{position:relative;max-width:360px;width:100%;outline:0;border-radius:var(--wcm-background-border-radius) var(--wcm-background-border-radius) var(--wcm-container-border-radius) var(--wcm-container-border-radius);border:1px solid var(--wcm-color-overlay);overflow:hidden}.wcm-card{width:100%;position:relative;border-radius:var(--wcm-container-border-radius);overflow:hidden;box-shadow:0 6px 14px -6px rgba(10,16,31,.12),0 10px 32px -4px rgba(10,16,31,.1),0 0 0 1px var(--wcm-color-overlay);background-color:var(--wcm-color-bg-1);color:var(--wcm-color-fg-1)}@media(max-width:600px){.wcm-container{max-width:440px;border-radius:var(--wcm-background-border-radius) var(--wcm-background-border-radius) 0 0}.wcm-card{border-radius:var(--wcm-container-border-radius) var(--wcm-container-border-radius) 0 0}.wcm-overlay{align-items:flex-end}}@media(max-width:440px){.wcm-container{border:0}}`;
var on = Object.defineProperty, rn = Object.getOwnPropertyDescriptor, kt = (t, e, o, i) => {
  for (var r = i > 1 ? void 0 : i ? rn(e, o) : e, n = t.length - 1, a; n >= 0; n--)
    (a = t[n]) && (r = (i ? a(e, o, r) : a(r)) || r);
...
Oe.styles = [v.globalCss, tn], kt([W()], Oe.prototype, "open", 2), kt([W()], Oe.prototype, "active", 2), Oe = kt([y("wcm-modal")], Oe);
const nn = C`div{display:flex;margin-top:15px}slot{display:inline-block;margin:0 5px}wcm-button{margin:0 5px}`;
var an = Object.defineProperty, ln = Object.getOwnPropertyDescriptor, Ie = (t, e, o, i) => {
...
oe.styles = [v.globalCss, nn], Ie([p({ type: Boolean })], oe.prototype, "isMobile", 2), Ie([p({ type: Boolean })], oe.prototype, "isDesktop", 2), Ie([p({ type: Boolean })], oe.prototype, "isWeb", 2), Ie([p({ type: Boolean })], oe.prototype, "isRetry", 2), oe = Ie([y("wcm-platform-selection")], oe);
const sn = C`button{display:flex;flex-direction:column;padding:5px 10px;border-radius:var(--wcm-button-hover-highlight-border-radius);height:100%;justify-content:flex-start}.wcm-icons{width:60px;height:60px;display:flex;flex-wrap:wrap;padding:7px;border-radius:var(--wcm-wallet-icon-border-radius);justify-content:space-between;align-items:center;margin-bottom:5px;background-color:var(--wcm-color-bg-2);box-shadow:inset 0 0 0 1px var(--wcm-color-overlay)}button:active{background-color:var(--wcm-color-overlay)}@media(hover:hover){button:hover{background-color:var(--wcm-color-overlay)}}.wcm-icons img{width:21px;height:21px;object-fit:cover;object-position:center;border-radius:calc(var(--wcm-wallet-icon-border-radius)/ 2);border:1px solid var(--wcm-color-overlay)}.wcm-icons svg{width:21px;height:21px}.wcm-icons img:nth-child(1),.wcm-icons img:nth-child(2),.wcm-icons svg:nth-child(1),.wcm-icons svg:nth-child(2){margin-bottom:4px}wcm-text{width:100%;text-align:center}#wallet-placeholder-fill{fill:var(--wcm-color-bg-3)}#wallet-placeholder-dash{stroke:var(--wcm-color-overlay)}`;
var cn = (t, e, o, i) => {
  for (var r = e, n = t.length - 1, a; n >= 0; n--)
    (a = t[n]) && (r = a(r) || r);
  return r;
...
Ot.styles = [v.globalCss, sn], Ot = cn([y("wcm-view-all-wallets-button")], Ot);
const dn = C`.wcm-qr-container{width:100%;display:flex;justify-content:center;align-items:center;aspect-ratio:1/1}`;
var hn = Object.defineProperty, mn = Object.getOwnPropertyDescriptor, ze = (t, e, o, i) => {
...
pe.styles = [v.globalCss, dn], ze([p()], pe.prototype, "walletId", 2), ze([p()], pe.prototype, "imageId", 2), ze([W()], pe.prototype, "uri", 2), pe = ze([y("wcm-walletconnect-qr")], pe);
var pn = (t, e, o, i) => {
  for (var r = e, n = t.length - 1, a; n >= 0; n--)
    (a = t[n]) && (r = a(r) || r);
  return r;
...
It.styles = [v.globalCss], It = pn([y("wcm-connect-wallet-view")], It);
const un = C`wcm-info-footer{flex-direction:column;align-items:center;display:flex;width:100%;padding:5px 0}wcm-text{text-align:center}`;
var gn = Object.defineProperty, wn = Object.getOwnPropertyDescriptor, fo = (t, e, o, i) => {
  for (var r = i > 1 ? void 0 : i ? wn(e, o) : e, n = t.length - 1, a; n >= 0; n--)
    (a = t[n]) && (r = (i ? a(e, o, r) : a(r)) || r);
...
Ve.styles = [v.globalCss, un], fo([W()], Ve.prototype, "isError", 2), Ve = fo([y("wcm-desktop-connecting-view")], Ve);
const vn = C`wcm-info-footer{flex-direction:column;align-items:center;display:flex;width:100%;padding:5px 0}wcm-text{text-align:center}wcm-button{margin-top:15px}`;
var fn = (t, e, o, i) => {
  for (var r = e, n = t.length - 1, a; n >= 0; n--)
    (a = t[n]) && (r = a(r) || r);
  return r;
...
Tt.styles = [v.globalCss, vn], Tt = fn([y("wcm-install-wallet-view")], Tt);
const bn = C`wcm-wallet-image{border-radius:var(--wcm-wallet-icon-large-border-radius);width:96px;height:96px;margin-bottom:20px}wcm-info-footer{display:flex;width:100%}.wcm-app-store{justify-content:space-between}.wcm-app-store wcm-wallet-image{margin-right:10px;margin-bottom:0;width:28px;height:28px;border-radius:var(--wcm-wallet-icon-small-border-radius)}.wcm-app-store div{display:flex;align-items:center}.wcm-app-store wcm-button{margin-right:-10px}.wcm-note{flex-direction:column;align-items:center;padding:5px 0}.wcm-note wcm-text{text-align:center}wcm-platform-selection{margin-top:-15px}.wcm-note wcm-text{margin-top:15px}.wcm-note wcm-text span{color:var(--wcm-accent-color)}`;
var yn = Object.defineProperty, xn = Object.getOwnPropertyDescriptor, bo = (t, e, o, i) => {
  for (var r = i > 1 ? void 0 : i ? xn(e, o) : e, n = t.length - 1, a; n >= 0; n--)
    (a = t[n]) && (r = (i ? a(e, o, r) : a(r)) || r);
...
Fe.styles = [v.globalCss, bn], bo([W()], Fe.prototype, "isError", 2), Fe = bo([y("wcm-mobile-connecting-view")], Fe);
const $n = C`wcm-info-footer{flex-direction:column;align-items:center;display:flex;width:100%;padding:5px 0}wcm-text{text-align:center}`;
var Cn = (t, e, o, i) => {
  for (var r = e, n = t.length - 1, a; n >= 0; n--)
    (a = t[n]) && (r = a(r) || r);
  return r;
...
Mt.styles = [v.globalCss, $n], Mt = Cn([y("wcm-mobile-qr-connecting-view")], Mt);
var An = (t, e, o, i) => {
  for (var r = e, n = t.length - 1, a; n >= 0; n--)
    (a = t[n]) && (r = a(r) || r);
  return r;
...
Rt.styles = [v.globalCss], Rt = An([y("wcm-qrcode-view")], Rt);
const _n = C`wcm-modal-content{height:clamp(200px,60vh,600px);display:block;overflow:scroll;scrollbar-width:none;position:relative;margin-top:1px}.wcm-grid{display:grid;grid-template-columns:repeat(4,80px);justify-content:space-between;margin:-15px -10px;padding-top:20px}wcm-modal-content::after,wcm-modal-content::before{content:'';position:fixed;pointer-events:none;z-index:1;width:100%;height:20px;opacity:1}wcm-modal-content::before{box-shadow:0 -1px 0 0 var(--wcm-color-bg-1);background:linear-gradient(var(--wcm-color-bg-1),rgba(255,255,255,0))}wcm-modal-content::after{box-shadow:0 1px 0 0 var(--wcm-color-bg-1);background:linear-gradient(rgba(255,255,255,0),var(--wcm-color-bg-1));top:calc(100% - 20px)}wcm-modal-content::-webkit-scrollbar{display:none}.wcm-placeholder-block{display:flex;justify-content:center;align-items:center;height:100px;overflow:hidden}.wcm-empty,.wcm-loading{display:flex}.wcm-loading .wcm-placeholder-block{height:100%}.wcm-end-reached .wcm-placeholder-block{height:0;opacity:0}.wcm-empty .wcm-placeholder-block{opacity:1;height:100%}wcm-wallet-button{margin:calc((100% - 60px)/ 3) 0}`;
var En = Object.defineProperty, kn = Object.getOwnPropertyDescriptor, Te = (t, e, o, i) => {
  for (var r = i > 1 ? void 0 : i ? kn(e, o) : e, n = t.length - 1, a; n >= 0; n--)
    (a = t[n]) && (r = (i ? a(e, o, r) : a(r)) || r);
  return i && r && En(e, o, r), r;
};
const St = 40;
...
re.styles = [v.globalCss, _n], Te([W()], re.prototype, "loading", 2), Te([W()], re.prototype, "firstFetch", 2), Te([W()], re.prototype, "search", 2), Te([W()], re.prototype, "endReached", 2), re = Te([y("wcm-wallet-explorer-view")], re);
const On = C`wcm-info-footer{flex-direction:column;align-items:center;display:flex;width:100%;padding:5px 0}wcm-text{text-align:center}`;
var In = Object.defineProperty, Tn = Object.getOwnPropertyDescriptor, yo = (t, e, o, i) => {
  for (var r = i > 1 ? void 0 : i ? Tn(e, o) : e, n = t.length - 1, a; n >= 0; n--)
    (a = t[n]) && (r = (i ? a(e, o, r) : a(r)) || r);
...
qe.styles = [v.globalCss, On], yo([W()], qe.prototype, "isError", 2), qe = yo([y("wcm-web-connecting-view")], qe);
export {
  Oe as WcmModal,
  F as WcmQrCode
};
