import { U as p } from "./client-CWmvRiz4.js";
function _(n, r) {
  ...
  async request(r) {
    ...
    switch (i) {
      ...
      case "eth_signTypedData_v4": {
        ...
        const d = await this.sdk.txs.signTypedMessage(h);
        return ("signature" in d ? d.signature : void 0) || "0x";
      }
      case "eth_sendTransaction":
        const s = Object.assign(Object.assign({}, e[0]), { value: e[0].value || "0", data: e[0].data || "0x" });
      ...
      case "eth_getTransactionByHash":
        ...
        return this.submittedTxs.has(c) ? this.submittedTxs.get(c) : this.sdk.eth.getTransactionByHash([c]).then((t) => (t && (t.hash = e[0]), t));
