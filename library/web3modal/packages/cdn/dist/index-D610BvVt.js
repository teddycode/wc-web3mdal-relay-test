import { B as f, n as an, o as L, q as on, Q as cn } from "./client-CWmvRiz4.js";
import { j as dn, r as Et, a as ln, b as un } from "./hooks.module-sSeeCr2O.js";
var St = {}, ne = {}, be = {};
...
const fn = X, mn = q, bn = B, yn = Fe;
function wn(n, e) {
  const t = (0, yn.serialize)(vn(n), {
    shouldIncludeStack: !0
  }), r = new URL("https://docs.cloud.coinbase.com/wallet-sdk/docs/errors");
  r.searchParams.set("version", mn.LIB_VERSION), r.searchParams.set("code", t.code.toString());
  const s = _n(t.data, e);
  return s && r.searchParams.set("method", s), r.searchParams.set("message", t.message), Object.assign(Object.assign({}, t), { docUrl: r.href });
}
ve.serializeError = wn;
function vn(n) {
  return typeof n == "string" ? {
    message: n,
    code: bn.standardErrorCodes.rpc.internal
  } : (0, fn.isErrorResponse)(n) ? Object.assign(Object.assign({}, n), { message: n.errorMessage, code: n.errorCode, data: { method: n.method } }) : n;
}
function _n(n, e) {
...
class $n {
  constructor() {
    this.storage = new qn.ScopedLocalStorage("CBWSDK", "SCWKeyManager"), this.ownPrivateKey = null, this.ownPublicKey = null, this.peerPublicKey = null, this.sharedSecret = null;
  }
...
const Fn = D, Xe = "accounts", et = "activeChain", tt = "availableChains", nt = "walletCapabilities";
class zn {
  get accounts() {
  ...
  constructor(e) {
    var t, r;
    this.storage = new Fn.ScopedLocalStorage("CBWSDK", "SCWStateManager"), this.updateListener = e.updateListener, this.availableChains = this.loadItemFromStorage(tt), this._walletCapabilities = this.loadItemFromStorage(nt);
...
Ce.SCWStateManager = zn;
Object.defineProperty(Ee, "__esModule", { value: !0 });
Ee.SCWSigner = void 0;
const Vn = Se, Zn = Ce, de = O, rt = u, le = w;
class Gn {
  constructor(e) {
    this.metadata = e.metadata, this.communicator = e.communicator, this.keyManager = new Vn.SCWKeyManager(), this.stateManager = new Zn.SCWStateManager({
...
function Ie(n) {
  if (!f.isBuffer(n))
    if (Array.isArray(n))
      ...
      Kt(n) ? n = f.from(nr(qt(n)), "hex") : n = f.from(n);
...
function tr(n, e) {
  return n = Ie(n), e || (e = 256), Yn("keccak" + e).update(n).digest();
}
function nr(n) {
...
function x(n, e) {
  ...
  if (sr(n)) {
    ...
    if (t = zt(n), t !== "dynamic" && t !== 0 && e.length > t)
...
function rr(n) {
  return n === "string" || n === "bytes" || zt(n) === "dynamic";
}
function sr(n) {
...
function ir(n, e) {
  ...
  for (var i in n) {
    ...
    rr(a) ? (t.push(x("uint256", s)), r.push(c), s += c.length) : t.push(c);
  }
...
class ur {
  ...
  makeRequestId() {
    ...
    const e = this._nextRequestId, t = (0, lr.prepend0x)(e.toString(16));
    return this.callbacks.get(t) && this.callbacks.delete(t), e;
  }
}
ae.RelayEventManager = ur;
var Me = {}, Le = {}, Ae = {};
Object.defineProperty(Ae, "__esModule", { value: !0 });
...
J.WalletLinkWebSocket = pr;
Object.defineProperty(Le, "__esModule", { value: !0 });
Le.WalletLinkConnection = void 0;
const it = T, fr = Ae, mr = Re, he = J, z = E, at = 1e4, br = 6e4;
class yr {
  /**
   * Constructor
  ...
  constructor({ session: e, linkAPIUrl: t, listener: r, WebSocketClass: s = WebSocket }) {
    this.destroyed = !1, this.lastHeartbeatResponse = 0, this.nextReqId = (0, z.IntNumber)(1), this._connected = !1, this._linked = !1, this.shouldFetchUnseenEventsOnConnect = !1, this.requestResolutions = /* @__PURE__ */ new Map(), this.handleSessionMetadataUpdated = (a) => {
      if (!a)
        return;
      (/* @__PURE__ */ new Map([
    ...
    }, this.session = e, this.cipher = new fr.WalletLinkCipher(e.secret), this.listener = r;
    ...
    }), this.ws = i, this.http = new mr.WalletLinkHTTP(t, e.id, e.key);
  }
  /**
  ...
  async setSessionMetadata(e, t) {
    const r = {
      ...
      id: (0, z.IntNumber)(this.nextReqId++),
...
Le.WalletLinkConnection = yr;
var xe = {};
Object.defineProperty(xe, "__esModule", { value: !0 });
xe.WalletLinkSession = void 0;
const wr = an, ot = u, ct = "session:id", dt = "session:secret", lt = "session:linked";
class Ve {
  constructor(e, t, r, s) {
    this._storage = e, this._id = t || (0, ot.randomBytesHex)(16), this._secret = r || (0, ot.randomBytesHex)(32), this._key = new wr.sha256().update(`${this._id}, ${this._secret} WalletLink`).digest("hex"), this._linked = !!s;
  }
  static load(e) {
...
function Er() {
  try {
    return _r() && window.top ? window.top.location : window.location;
  } catch {
...
function Mr() {
  ...
  n.type = "text/css", n.appendChild(document.createTextNode(Ir.default)), document.documentElement.appendChild(n);
}
oe.injectCssReset = Mr;
var Ge = {};
function Gt(n) {
  var e, t, r = "";
...
const Lr = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  ...
  clsx: ut,
  default: ut
}, Symbol.toStringTag, { value: "Module" })), Yt = /* @__PURE__ */ on(Lr);
var Ye = {};
...
(function(n) {
  ...
  const m = ({ autoExpand: d, message: p, menuItems: b }) => {
    const [H, nn] = (0, s.useState)(!0), [De, Qe] = (0, s.useState)(d ?? !1);
    (0, s.useEffect)(() => {
      const A = [
        window.setTimeout(() => {
          nn(!1);
    ...
    return (0, r.h)(
      ...
      (0, r.h)(
        "div",
        { class: "-cbwsdk-snackbar-instance-header", onClick: rn },
      ...
      b && b.length > 0 && (0, r.h)("div", { class: "-cbwsdk-snackbar-instance-menu" }, b.map((A, sn) => (0, r.h)(
        "div",
        { class: (0, t.default)("-cbwsdk-snackbar-instance-menu-item", A.isRed && "-cbwsdk-snackbar-instance-menu-item-is-red"), onClick: A.onClick, key: sn },
        (0, r.h)(
          "svg",
...
class xr {
  constructor() {
    this.attached = !1, this.snackbar = new Rr.Snackbar();
  }
  attach() {
    if (this.attached)
      throw new Error("Coinbase Wallet SDK UI is already attached");
    const e = document.documentElement, t = document.createElement("div");
    t.className = "-cbwsdk-css-reset", e.appendChild(t), this.snackbar.attach(t), this.attached = !0, (0, Ar.injectCssReset)();
  }
  showConnecting(e) {
    let t;
...
var Jt = L && L.__importDefault || function(n) {
  return n && n.__esModule ? n : { default: n };
};
Object.defineProperty(Te, "__esModule", { value: !0 });
Te.RedirectDialog = void 0;
const Pr = Jt(Yt), P = Et, Nr = oe, Tr = Ge, jr = C, Or = Jt(Je);
class Dr {
  constructor() {
  ...
  attach() {
    ...
    this.root = document.createElement("div"), this.root.className = "-cbwsdk-css-reset", e.appendChild(this.root), (0, Nr.injectCssReset)();
  }
  present(e) {
    this.render(e);
  }
  ...
  render(e) {
    this.root && ((0, P.render)(null, this.root), e && (0, P.render)((0, P.h)(Wr, Object.assign({}, e, { onDismiss: () => {
      this.clear();
    }, darkMode: this.darkMode })), this.root));
  }
}
Te.RedirectDialog = Dr;
const Wr = ({ title: n, buttonText: e, darkMode: t, onButtonClick: r, onDismiss: s }) => {
  const i = t ? "dark" : "light";
  return (0, P.h)(
    Tr.SnackbarContainer,
    { darkMode: t },
    (0, P.h)(
      "div",
      { class: "-cbwsdk-redirect-dialog" },
      (0, P.h)("style", null, Or.default),
      (0, P.h)("div", { class: "-cbwsdk-redirect-dialog-backdrop", onClick: s }),
      (0, P.h)(
        "div",
        { class: (0, Pr.default)("-cbwsdk-redirect-dialog-box", i) },
        (0, P.h)("p", null, n),
...
const Ur = Te, Br = C, Hr = j;
class Kr {
  constructor() {
    this.attached = !1, this.redirectDialog = new Ur.RedirectDialog();
  }
  attach() {
    if (this.attached)
      throw new Error("Coinbase Wallet SDK UI is already attached");
  ...
  redirectToCoinbaseWallet(e) {
    const t = new URL(Hr.CBW_MOBILE_DEEPLINK_URL);
    t.searchParams.append("redirect_url", (0, Br.getLocation)().href), e && t.searchParams.append("wl_url", e);
...
Ne.WLMobileRelayUI = Kr;
Object.defineProperty(Me, "__esModule", { value: !0 });
Me.WalletLinkRelay = void 0;
const qr = Le, $r = T, Fr = ae, Ke = xe, V = X, zr = C, Vr = Pe, ht = Ne, Zr = O, y = u, Gr = D;
class U {
  constructor(e) {
    this.accountsCallback = null, this.chainCallbackParams = { chainId: "", jsonRpcUrl: "" }, this.chainCallback = null, this.dappDefaultChain = 1, this.isMobileWeb = (0, zr.isMobileWeb)(), this.appName = "", this.appLogoUrl = null, this.linkedUpdated = (i) => {
      this.isLinked = i;
      const a = this.storage.getItem($r.LOCAL_STORAGE_ADDRESSES_KEY);
    ...
    this._session = t, this.connection = s, this.relayEventManager = new Fr.RelayEventManager(), this.ui = r;
  }
  subscribe() {
    const e = Ke.WalletLinkSession.load(this.storage) || new Ke.WalletLinkSession(this.storage).save(), { linkAPIUrl: t } = this, r = new qr.WalletLinkConnection({
      session: e,
      linkAPIUrl: t,
      listener: this
    }), s = this.isMobileWeb ? new ht.WLMobileRelayUI() : new Vr.WalletLinkRelayUI();
  ...
  resetAndReload() {
    Promise.race([
      ...
      (e == null ? void 0 : e.id) === this._session.id && Gr.ScopedLocalStorage.clearAll(), document.location.reload();
    }).catch((e) => {
    });
  }
  setAppInfo(e, t) {
    ...
    return new Promise((i, a) => {
      this.relayEventManager.callbacks.set(s, (o) => {
        if ((0, V.isErrorResponse)(o) && o.errorCode)
          return a(Zr.standardErrors.provider.custom({
            code: o.errorCode,
            message: "Unrecognized chain ID. Try adding the chain using addEthereumChain first."
          }));
        if ((0, V.isErrorResponse)(o))
          return a(new Error(o.errorMessage));
        i(o);
...
var Yr = L && L.__importDefault || function(n) {
  return n && n.__esModule ? n : { default: n };
};
Object.defineProperty(ke, "__esModule", { value: !0 });
ke.WalletLinkSigner = void 0;
const qe = Yr(cr), gt = T, Jr = ae, W = X, Qr = Me, pt = j, v = O, g = u, Xr = D, $e = "DefaultChainId", ft = "DefaultJsonRpcUrl";
class es {
  constructor(e) {
    var t, r;
    this._relay = null, this._addresses = [], this.hasMadeFirstChainChangedEmission = !1;
    const { appName: s, appLogoUrl: i } = e.metadata;
    this._appName = s, this._appLogoUrl = i, this._storage = new Xr.ScopedLocalStorage("walletlink", pt.WALLETLINK_URL), this.updateListener = e.updateListener, this._relayEventManager = new Jr.RelayEventManager(), this._jsonRpcUrlFromOpts = "";
  ...
  get jsonRpcUrl() {
    var e;
    return (e = this._storage.getItem(ft)) !== null && e !== void 0 ? e : this._jsonRpcUrlFromOpts;
  }
  set jsonRpcUrl(e) {
  ...
  initializeRelay() {
    if (!this._relay) {
      const e = new Qr.WalletLinkRelay({
...
async function ns(n, e) {
  ...
  return (await (await window.fetch(e.rpcUrl, {
    ...
    mode: "cors",
    headers: { "Content-Type": "application/json", "X-Cbw-Sdk-Version": ts.LIB_VERSION }
  })).json()).result;
}
I.fetchRPCRequest = ns;
function Qt() {
  return globalThis.coinbaseWalletSigner;
}
I.getCoinbaseInjectedSigner = Qt;
function rs() {
...
function is({ metadata: n, preference: e }) {
  var t;
...
I.getCoinbaseInjectedProvider = is;
function as(n) {
  if (!n || typeof n != "object" || Array.isArray(n))
...
I.checkErrorForInvalidRequestArgs = as;
Object.defineProperty(N, "__esModule", { value: !0 });
N.createSigner = N.fetchSignerType = N.storeSignerType = N.loadSignerType = void 0;
const os = Ee, Xt = ke, cs = O, ds = I, ls = D, en = "SignerType", tn = new ls.ScopedLocalStorage("CBWSDK", "SignerConfigurator");
function us() {
  return tn.getItem(en);
}
N.loadSignerType = us;
function hs(n) {
  tn.setItem(en, n);
}
N.storeSignerType = hs;
async function gs(n) {
...
N.fetchSignerType = gs;
function ps(n) {
  const { signerType: e, metadata: t, communicator: r, updateListener: s } = n;
  switch (e) {
    case "scw":
      return new os.SCWSigner({
        metadata: t,
        updateListener: s,
        communicator: r
      });
    case "walletlink":
      return new Xt.WalletLinkSigner({
        metadata: t,
        updateListener: s
      });
    case "extension": {
      const i = (0, ds.getCoinbaseInjectedSigner)();
      if (!i)
        throw cs.standardErrors.rpc.internal("injected signer not found");
      return i;
    }
  }
}
...
async function fs(n, e) {
  ...
  const t = new Xt.WalletLinkSigner({
    metadata: e
  });
  n.postMessage({
...
const ms = O, mt = 420, bt = 540;
function bs(n) {
  const e = (window.innerWidth - mt) / 2 + window.screenX, t = (window.innerHeight - bt) / 2 + window.screenY, r = window.open(n, "Smart Wallet", `width=${mt}, height=${bt}, left=${e}, top=${t}`);
  if (r == null || r.focus(), !r)
    throw ms.standardErrors.rpc.internal("Pop up window failed to open");
  return r;
}
Q.openPopup = bs;
function ys(n) {
...
const ws = q, yt = Q, vs = j, wt = O;
class _s {
  constructor(e = vs.CB_KEYS_URL) {
    this.popup = null, this.listeners = /* @__PURE__ */ new Map(), this.postMessage = async (t) => {
      ...
      (0, yt.closePopup)(this.popup), this.popup = null, this.listeners.forEach(({ reject: t }, r) => {
        t(wt.standardErrors.provider.userRejectedRequest("Request rejected")), window.removeEventListener("message", r);
      }), this.listeners.clear();
    }, this.waitForPopupLoaded = async () => this.popup && !this.popup.closed ? (this.popup.focus(), this.popup) : (this.popup = (0, yt.openPopup)(this.url), this.onMessage(({ event: t }) => t === "PopupUnload").then(this.disconnect).catch(() => {
    }), this.onMessage(({ event: t }) => t === "PopupLoaded").then((t) => {
      this.postMessage({
        requestId: t.id,
        data: { version: ws.LIB_VERSION }
      });
    }).then(() => {
      if (!this.popup)
        throw wt.standardErrors.rpc.internal();
      return this.popup;
    })), this.url = new URL(e);
  }
}
...
Oe.determineMethodCategory = Es;
var Ss = L && L.__rest || function(n, e) {
  var t = {};
  for (var r in n)
  ...
  return t;
}, Cs = L && L.__importDefault || function(n) {
  return n && n.__esModule ? n : { default: n };
};
Object.defineProperty(ye, "__esModule", { value: !0 });
ye.CoinbaseWalletProvider = void 0;
const ks = Cs(un), Z = O, Is = ve, ge = E, ee = u, pe = N, _t = I, Ms = je, Ls = Oe, As = D;
class Rs extends ks.default {
  constructor(e) {
    var t, r, { metadata: s } = e, i = e.preference, { keysUrl: a } = i, o = Ss(i, ["keysUrl"]);
    ...
    }, this.metadata = s, this.preference = o, this.communicator = new Ms.Communicator(a), this.chain = {
  ...
  async request(e) {
    var t;
    try {
      const r = (0, _t.checkErrorForInvalidRequestArgs)(e);
      if (r)
        throw r;
      const s = (t = (0, Ls.determineMethodCategory)(e.method)) !== null && t !== void 0 ? t : "fetch";
      return this.handlers[s](e);
    } catch (r) {
      return Promise.reject((0, Is.serializeError)(r, e.method));
    }
  }
  ...
  async disconnect() {
    this.accounts = [], this.chain = { id: 1 }, As.ScopedLocalStorage.clearAll(), this.emit("disconnect", Z.standardErrors.provider.disconnected("User initiated disconnection"));
  }
...
ye.CoinbaseWalletProvider = Rs;
Object.defineProperty(ne, "__esModule", { value: !0 });
ne.CoinbaseWalletSDK = void 0;
const xs = be, Ps = ye, Ns = D, Ts = q, js = u, Os = I;
class Ds {
  constructor(e) {
    this.metadata = {
  ...
  makeWeb3Provider(e = { options: "all" }) {
    ...
    return (t = (0, Os.getCoinbaseInjectedProvider)(r)) !== null && t !== void 0 ? t : new Ps.CoinbaseWalletProvider(r);
  }
  /**
  ...
  getCoinbaseWalletLogo(e, t = 240) {
    return (0, xs.walletLogo)(e, t);
  }
  storeLatestVersion() {
    new Ns.ScopedLocalStorage("CBWSDK").setItem("VERSION", Ts.LIB_VERSION);
  }
}
ne.CoinbaseWalletSDK = Ds;
(function(n) {
...
const Ws = /* @__PURE__ */ cn(St), Hs = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  default: Ws
